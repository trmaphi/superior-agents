...
class MockRAGClient:
    ...
    def save_result_batch_v4(self, batch_data: List[StrategyData]) -> dict:
        ...
        for data in batch_data:
            ...
            if isinstance(data.parameters, str):
                try:
                    ...
                    data_params = json.loads(parsed) if isinstance(parsed, str) else parsed
                except Exception:
                    data_params = {}
            else:
        ...
        return {"status": "success", "message": "Mock V4 save completed", "data": payload}
    ...
    def relevant_strategy_raw(self, query: str | None) -> List[StrategyData]:
        ...
        return [StrategyData(strategy_id="mock-001", agent_id="mock-001", summarized_desc="Mock strategy result", full_desc="", created_at=datetime.now(), parameters={}, strategy_result="success")]
    ...
    def relevant_strategy_raw_v2(self, query: str) -> List[Tuple[StrategyData, float]]:
        ...
        return [
            (
                StrategyData(strategy_id="mock-002", agent_id="mock-002", summarized_desc="Mock strategy result v2", full_desc="", created_at=datetime.now(), parameters={}, strategy_result="success"),
                0.95,
            )
        ]
    ...
    def relevant_strategy_raw_v4(self, query: str) -> List[Tuple[StrategyData, float]]:
        ...
        return [
            (
                StrategyData(strategy_id="mock-003", agent_id="mock-003", summarized_desc="Mock strategy result v4", full_desc="", created_at=datetime.now(), parameters={}, strategy_result="success"),
                0.89,
            )
        ]
