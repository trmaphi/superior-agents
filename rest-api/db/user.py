...
def insert_users_db(cursor, insert_dict):
    """Insert a new user record (SQLite version)"""
...
def update_users_db(cursor, set_dict, where_dict):
    """Update existing user record (SQLite version)"""
...
def get_all_users_db(
    ...
    """Retrieve users with pagination (SQLite version)"""
    ...
    order_by_clause = (
        f"ORDER BY sup_users.{pagination['sort_by']} ASC"
