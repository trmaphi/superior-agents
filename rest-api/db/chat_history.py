...
@db_connection_decorator
def get_all_chat_history_db(cursor, result_columns: list, where_conditions: dict, pagination) -> str:
    ...
    order_by_clause = f"ORDER BY sup_chat_history.{pagination['sort_by']} ASC" if 'sort_by' in pagination else ""
